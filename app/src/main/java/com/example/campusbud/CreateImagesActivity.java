...
public class CreateImagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIvProfile = findViewById(R.id.ivCreateProfilePic);
        mIvImage1 = findViewById(R.id.ivCreatePicture1);
        mIvImage2 = findViewById(R.id.ivCreatePicture2);
        mIvImage3 = findViewById(R.id.ivCreatePicture3);
        Button mBtnImagesContinue = findViewById(R.id.btnCreateAccount);
